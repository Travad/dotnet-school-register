...
namespace dotnet_school_register.Migrations
{
    ...
    [Migration("20220710163219_FinalTemplateModel")]
    partial class FinalTemplateModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.Attendees.Attendee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.CourseAttendees.CourseAttendee", b =>
                {
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.Courses.Course", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.Grades.Grade", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.Attendees.Attendee", b =>
                {
                    b.HasOne("dotnet_school_register.Entities.Students.Student", "Student")
                        .WithMany()
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.CourseAttendees.CourseAttendee", b =>
                {
                    b.HasOne("dotnet_school_register.Entities.Attendees.Attendee", "Attendee")
                        .WithMany("CourseAttendees")
                        .HasForeignKey("AttendeeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("dotnet_school_register.Entities.Courses.Course", "Course")
                        .WithMany("CourseAttendees")
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.Courses.Course", b =>
                {
                    b.HasOne("dotnet_school_register.Entities.Schools.School", "School")
                        .WithMany()
            ...
            modelBuilder.Entity("dotnet_school_register.Entities.Grades.Grade", b =>
                {
                    b.HasOne("dotnet_school_register.Entities.CourseAttendees.CourseAttendee", "CourseAttendee")
                        .WithMany("Grades")
